    ...
    <SafeAreaView edges={['top']} style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.readOnlyCard}>
          <Text style={styles.readOnlyCardLabel}>Diagnóstico</Text>
          <Text style={styles.readOnlyCardValue}>
            {PATIENT_PROFILE.diagnosis}
          </Text>

          <View style={styles.readOnlyDivider} />

          <Text style={styles.readOnlyCardLabel}>Fisioterapeuta asignado</Text>
          <Text style={styles.readOnlyCardValue}>
            {PATIENT_PROFILE.assignedTherapist}
          </Text>

          <Text style={styles.readOnlyHint}>
            El diagnóstico y el terapeuta son asignados por tu profesional de
            salud y no se pueden modificar desde la aplicación.
          </Text>
        </View>
