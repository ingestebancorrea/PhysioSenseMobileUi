...
const TOGGLE_OPTIONS: ToggleOption[] = [
  ...
  },
  {
    ...
    description: 'Avisos de tus próximas sesiones.',
  },
  {
    id: 'results',
    title: 'Resultados de ejercicios',
    description: 'Cuando finalices o avances en tus ejercicios.',
  },
  {
    id: 'messages',
    title: 'Mensajes del fisioterapeuta',
    description: 'Nuevos mensajes de tu terapeuta.',
  },
  {
    id: 'tips',
    title: 'Consejos de recuperación',
    description: 'Recomendaciones para tu rehabilitación.',
  },
];
...
interface PatientNotificationsSettingsScreenProps {
  onBack?: () => void;
}

export const PatientNotificationsSettingsScreen: React.FC<
  PatientNotificationsSettingsScreenProps
> = ({ onBack }) => {
...
export default PatientNotificationsSettingsScreen;