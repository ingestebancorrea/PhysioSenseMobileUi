      ...
      >
        ...
        <View style={styles.banner}>
          <View style={styles.bannerIcon}>
            <ShieldCheck size={28} color={COLORS.primaryViolet} />
          </View>

          <View style={styles.bannerText}>
            <Text style={styles.bannerTitle}>Tu cuenta está protegida</Text>
            <Text style={styles.bannerDescription}>
              Usamos los más altos estándares de seguridad para cuidar tu
              información.
            </Text>
          </View>
        </View>
